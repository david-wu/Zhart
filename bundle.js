...
// TODO: Draw a box around options.domain
layers.miniDomain = function(options){
    ...
    function draw(zhart){
        ...
        var xMin = zhart.xScale(options.domain[0]);
        var xMax = zhart.xScale(options.domain[1]);

        var rect = zhart.vis.selectAll('rect.green-box')
            .data([0])

console.log(zhart.vis, rect)
        rect
            .enter()
            .append('rect')
            .classed('green-box', true)
    ...
    function draw(zhart){
        ...
        areas.enter()
            .append('svg:path')
                ...
                .attr('stroke', 'none')
                .attr('stroke-width', 0)
                .attr('clip', 'rect(0px,10px,10px,0px)');
...
},{"./Features.helpers":5,"./Layers.helpers":6,"d3":1,"lodash":2}],8:[function(require,module,exports){
var _ = require('lodash');
...
},{"./DataSet":3,"./Domain":4,"./Zhart.Core":7,"lodash":2}]},{},[8]);
